...
function App() {
  return (
    ...
    <a href="#" className="toggle-button"><i className="fas fa-bars"></i></a>
    <div className="navbar-links">
      <ul>
        <li><a className="link" href="#home-section">Home</a></li>
        <li><a className="link" href="#projects-section">Projects</a></li>
        <li><a className="link" href="#about-section">About</a></li>
        <li><a className="link" href="/resume.html">Resume</a></li>
      </ul>
    </div>
  </div>
  ...
  <div className="container">
    <div className="home" id="home-section">
      ...
      <p className="home__text">
        Hi! I'm a Frontend Engineer based in Bangalore, India. I specialize in
        crafting dynamic websites and small-scale projects.
      </p>
    </div>
        ...
        <div className="projects__container--item">
          <a href="https://github.com/girlwhodrawsandstuff/day-planner">
            ...
            <p>
              ...
              HTML, CSS and JavaScript for the frontend where users can login
              and keep track of their daily tasks.
            </p>
          </a>
        </div>
        <div className="projects__container--item">
        ...
        <div className="projects__container--item">
          ...
          >
            ...
            <p>
              ...
              backend. It uses functional components with hooks and the context
              API.
            </p>
          </a>
        </div>
        <div className="projects__container--item">
          <a href="https://github.com/girlwhodrawsandstuff/react-mini-blog">
            ...
            <p>
              ...
              templates and components, click events, using state, props, hooks,
              custom hooks, handling GET and POST requests, etc.
            </p>
          </a>
        </div>
      </div>
    ...
    <div className="about" id="about-section">
      ...
      <p className="about__description">
        ...
        JavaScript, I leverage frameworks like AngularJS and ReactJS to deliver
        seamless user experiences. With a passion for creating innovative
        digital solutions, I thrive on bringing ideas to life through code.
        Having completed my B.C.A (Bachelor's in Computer Applications), I have
        transitioned into a full-time role at Razorpay, a prominent payments
        solution company in India. Prior to this role, I gained valuable
        industry experience through internships at Razorpay, Bikenbiker and
        RedGreen Engineering.
      </p>
      <p>
        Outside of work, I enjoy a range of hobbies such as roller-skating,
        drawing, and knitting while relaxing on my grandma-style rocking chair.
      </p>
    </div>
    ...
    <div className="footer">
      ...
      <a href="#page-top"><i className="fas fa-arrow-circle-up"></i></a>
    </div>
  </div>
    </>
  )
